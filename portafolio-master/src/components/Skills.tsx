...
const Skills = () => {
  ...
  const skills = [
    ...
    },
    {
      ...
      items: [
        { name: t('skills.testing.skills.junit'), icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/grafana/grafana-original.svg" },
        ...
        { name: t('skills.testing.skills.e2e'), icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sonarqube/sonarqube-original.svg" }
      ]
    }
  ];
