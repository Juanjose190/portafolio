    ...
    <section id="education" className="py-20 bg-[#1A1A2E]">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-2xl font-bold mb-4">Ingeniería de Software</h3>
            <p className="text-gray-300 mb-4">Actualmente cursando el 5to semestre de 8</p>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#E94560] pl-4">
                <h4 className="text-xl font-semibold">Certificación en Java</h4>
                <p className="text-gray-300">Universidad Mariana - Pasto, Nariño</p>
