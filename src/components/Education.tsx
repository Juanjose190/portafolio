        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative h-64 w-48 mx-auto">
              {/* Animación creativa para mostrar el progreso */}
              <motion.svg
                viewBox="0 0 120 140"
              ...
              >
                ...
                {/* Portal del conocimiento (círculo principal) */}
                <motion.circle
                  cx="60"
                  cy="60"
                  r="15"
                ...
                {/* Rayo energético que conecta la base y el portal */}
                <motion.rect
                  x="58"
                  y="75"
                  width="4"
