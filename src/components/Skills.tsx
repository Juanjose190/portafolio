  ...
  const skills = [
    {
      ...
      items: [
        ...
        { name: "C++", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cplusplus/cplusplus-original.svg", learning: true }
      ]
    },
    {
      ...
      items: [
        ...
        { name: t('skills.frontend.skills.angular'), icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/angularjs/angularjs-original.svg" },
